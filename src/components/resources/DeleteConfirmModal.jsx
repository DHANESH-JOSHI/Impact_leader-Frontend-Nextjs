              ...
              {resourceTitle && (
                ...
                >
                  <div className="flex items-center space-x-2">
                    <FolderOpen className="h-4 w-4 text-red-500 flex-shrink-0" />
                    <p
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div className="text-left">
                    ...
                    <ul className="text-xs text-red-700 space-y-1">
                      <li>• This resource will be permanently deleted</li>
                      <li>• All uploaded files will be removed from storage</li>
                      <li>• View statistics and download data will be lost</li>
                      <li>• This action cannot be reversed</li>
                      <li>• Any embedded content will stop working</li>
                    </ul>
                  </div>
                </div>
              </motion.div>
