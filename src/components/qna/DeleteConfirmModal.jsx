          ...
          >
            ...
            <div className="p-6 text-center">
              ...
              <p className="text-sm mb-4" style={{ color: "#646464" }}>
                Are you sure you want to delete this Q&A entry? This action
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div className="text-left">
                    ...
                    <ul className="text-xs text-red-700 space-y-1">
                      <li>• This Q&A entry will be permanently deleted</li>
                      <li>
                        • All view statistics and engagement data will be lost
                      </li>
                      <li>• User ratings and feedback will be removed</li>
                      <li>• This action cannot be reversed</li>
                      <li>• Any links to this Q&A will become invalid</li>
                    </ul>
                  </div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-xs text-yellow-800">
                    <strong>Pro tip:</strong> Consider archiving Q&A entries
                    instead of deleting them. Archived entries can be restored
                    later and preserve valuable user engagement data.
                  </p>
                </div>
              </motion.div>
            </div>
